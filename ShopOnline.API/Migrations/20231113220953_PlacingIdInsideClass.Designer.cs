...
namespace ShopOnline.API.Migrations
{
    ...
    [Migration("20231113220953_PlacingIdInsideClass")]
    partial class PlacingIdInsideClass
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShopOnline.API.Modules.Carts.Entities.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShopOnline.API.Modules.Carts.Entities.CartProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShopOnline.API.Modules.Products.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShopOnline.API.Modules.Products.Entities.ProductCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShopOnline.API.Modules.Users.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShopOnline.API.Modules.Carts.Entities.Cart", b =>
                {
                    b.HasOne("ShopOnline.API.Modules.Users.Entities.User", "User")
                        .WithMany("Carts")
            ...
            modelBuilder.Entity("ShopOnline.API.Modules.Carts.Entities.CartProduct", b =>
                {
                    b.HasOne("ShopOnline.API.Modules.Carts.Entities.Cart", "Cart")
                        .WithMany("CartProducts")
                        .HasForeignKey("CartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ShopOnline.API.Modules.Products.Entities.Product", "Product")
                        .WithMany("CartProducts")
            ...
            modelBuilder.Entity("ShopOnline.API.Modules.Products.Entities.Product", b =>
                {
                    b.HasOne("ShopOnline.API.Modules.Products.Entities.ProductCategory", "Category")
                        .WithMany("Products")
